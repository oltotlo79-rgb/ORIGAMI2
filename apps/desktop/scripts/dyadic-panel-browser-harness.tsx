...
const evidence = { reads: 0, mints: 0, applyAttempts: 0, mutations: 0, failures: 0, cancels: 0, timelineDtos: 0, undos: 0, redos: 0, reopens: 0 }
let callback = 0
let liveRevision = 1
let consumed = false

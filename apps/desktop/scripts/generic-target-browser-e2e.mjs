...
try {
  ...
  await page.getByRole('button', { name: 'Archive GLB reference 2' }).click()
  await page.getByText('Archived GLB reference 2 without deleting bytes; active reference cleared', { exact: true }).waitFor()
  await page.getByRole('button', { name: 'Restore archived GLB reference 2' }).click()
  await page.getByText('Restored archived GLB reference 2', { exact: true }).waitFor()
  await page.getByRole('button', { name: 'Activate GLB reference 2' }).click()

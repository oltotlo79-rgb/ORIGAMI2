...
try {
  ...
  await page.getByRole('button', { name: 'Reverse fold timeline', exact: true }).click(); await page.getByText('3. 中割り折り 2 · 完成形サムネイル', { exact: true }).click(); await page.getByLabel('構造化経路証明', { exact: true }).waitFor()

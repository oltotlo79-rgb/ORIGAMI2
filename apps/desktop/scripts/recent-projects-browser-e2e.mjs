...
try {
  ...
  await page.getByRole('heading', { name: '最近使った作品' }).waitFor(); await page.getByRole('button', { name: '折り鶴' }).click()
  ...
  console.log('recent projects browser E2E passed: pathless list and native invalidation')

...
#[cfg(test)]
use ori_domain::InstructionHingeAngle;
...
use self::stacked_fold_blockwise_cycle::{
    certified_blockwise_layer_pairs_v1, prepare_blockwise_current_cycle_fallback_v1,
};
#[cfg(test)]
...
async fn propose_current_stacked_fold_read_inner(
    ...
    let analysis = tauri::async_runtime::spawn_blocking(move || {
        ...
        let native_transaction = transaction_layer_order.map(|layer_order| {
            NativeStackedFoldPremises::Tree(

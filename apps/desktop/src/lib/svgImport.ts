...
import {
  formatSvgImportStylePresentation,
  formatSvgImportWarningPresentation,
  SVG_IMPORT_PRESENTATION_TEXT,
  svgImportTargetLabel,
...
export const SVG_IMPORT_TARGET_OPTIONS: ReadonlyArray<Readonly<{
  ...
  {
    value: 'boundary',
    label: SVG_IMPORT_PRESENTATION_TEXT.targetLabels.boundary.ja,
  },
  {
    value: 'mountain',
    label: SVG_IMPORT_PRESENTATION_TEXT.targetLabels.mountain.ja,
  },
  {
    value: 'valley',
    label: SVG_IMPORT_PRESENTATION_TEXT.targetLabels.valley.ja,
  },
  {
    value: 'auxiliary',
    label: SVG_IMPORT_PRESENTATION_TEXT.targetLabels.auxiliary.ja,
  },
  {
    value: 'cut',
    label: SVG_IMPORT_PRESENTATION_TEXT.targetLabels.cut.ja,
  },
  {
    value: 'ignore',
    label: SVG_IMPORT_PRESENTATION_TEXT.targetLabels.ignore.ja,
  },
]
...
export function localizedSvgImportTargetOptions(
  ...
  return Object.freeze(svgImportTargetOptions(boundaryCandidateId).map(({ value }) =>
    Object.freeze({
      value,
      label: svgImportTargetLabel(value, locale),
    })))
}
...
export function svgImportStyleLabel(
  ...
  return formatSvgImportStylePresentation(
    group,
    isSvgImportLineCap(group.line_cap),
    locale,
  )
...
export function svgImportWarningText(
  ...
  return formatSvgImportWarningPresentation(
    warning,
    locale,
  )
}

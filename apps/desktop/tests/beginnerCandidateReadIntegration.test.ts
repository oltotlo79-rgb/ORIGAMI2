...
const app = [
  ...
  readFileSync(new URL('../src/components/BeginnerReferenceSuggestionPanel.tsx', import.meta.url), 'utf8'),
  readFileSync(new URL('../src/components/BeginnerDesignConstraints.tsx', import.meta.url), 'utf8'),
  readFileSync(new URL('../src/components/BeginnerSkeletonEditor.tsx', import.meta.url), 'utf8'),
  readFileSync(new URL('../src/components/BeginnerProtrusionEditor.tsx', import.meta.url), 'utf8'),
  readFileSync(new URL('../src/components/ProjectMemoAndCandidateSection.tsx', import.meta.url), 'utf8'),

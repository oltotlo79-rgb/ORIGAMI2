...
test('throwing and malformed job steps never reach angle application', () => {
  const malformedSteps: unknown[] = [
    ...
    {
      ...blocked(0.2),
      unsafeBracket: [0.3, 0.2],
      blockingSampleTime: 0.2,
    },
    {
      ...blocked(0.2),
      unsafeBracket: [0.1, 0.3],
      blockingSampleTime: 0.3,
    },
    {
      ...blocked(0.2),
      unsafeBracket: [0.2, 0.2],
      blockingSampleTime: 0.2,
    },
    {
      kind: 'blocked',
      certifiedSafeThrough: 0.2,
      stopTime: 0.2,
      unsafeBracket: [0.2, 1],
      stats,
    },
    { ...blocked(0.2), blockingSampleTime: undefined },
    { ...blocked(0.2), blockingSampleTime: Number.NaN },
    { ...blocked(0.2), blockingSampleTime: 0.9 },
    blocked(1),

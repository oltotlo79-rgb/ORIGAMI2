...
#[cfg(test)]
#[path = "../../../test-support/n32_compact_pair_assignment_v2.rs"]
mod n32_compact_pair_assignment_test_support;
...
pub use block_composition::{
    ...
    CompleteMultiBlockPositiveLayerAuthorityV1, CompleteMultiBlockPositiveLayerAuthorityV2,
    CompleteMultiBlockPositiveLayerErrorV2, CompleteMultiBlockPositiveLayerInputV2,
    CompleteMultiBlockPositiveLayerLimitsV2, CompleteMultiBlockPositiveLayerResourcesV2,
    CompleteMultiBlockPositiveLayerRevalidationInputV2, MULTI_BLOCK_MAX_BLOCKS_V1,
...
pub use common_articulation_clearance::{
    ...
    COMMON_ARTICULATION_CLEARANCE_EXTENSION_MAX_CROSS_BLOCK_PAIRS_V1,
    COMMON_ARTICULATION_CLEARANCE_EXTENSION_MAX_FACES_V1,
    COMMON_ARTICULATION_CLEARANCE_EXTENSION_MAX_WORK_V1,
...
pub use common_articulation_dynamic_closure_clearance_v2::{
    ...
    CommonArticulationDynamicClosureClearanceStopV2,
...
pub use common_articulation_general_cell_transport_v2::{
    ...
    CommonArticulationDynamicGeneralNClosedDyadicRepresentationBoundaryPoseCanonicalBinary64TransformPositiveThicknessPrerequisiteErrorV2,
    ...
    prove_common_articulation_dynamic_general_n_closed_dyadic_boundary_configuration_positive_thickness_prerequisite_v2,
    ...
    prove_common_articulation_dynamic_general_n_closed_dyadic_endpoint_positive_thickness_prerequisite_v2,
    prove_common_articulation_dynamic_general_n_closed_dyadic_endpoint_positive_thickness_prerequisite_with_checkpoint_v2,
    prove_common_articulation_dynamic_general_n_closed_dyadic_representation_boundary_pose_angle_identity_positive_thickness_prerequisite_v2,
    prove_common_articulation_dynamic_general_n_closed_dyadic_representation_boundary_pose_angle_identity_positive_thickness_prerequisite_with_checkpoint_v2,
    prove_common_articulation_dynamic_general_n_closed_dyadic_representation_boundary_pose_canonical_binary64_transform_positive_thickness_prerequisite_v2,
    prove_common_articulation_dynamic_general_n_closed_dyadic_representation_boundary_pose_canonical_binary64_transform_positive_thickness_prerequisite_with_checkpoint_v2,
...
pub use continuous_path::{
    ...
    CommonArticulationPositiveThicknessContinuousRevalidationInputV1,
    CommonArticulationPositiveThicknessContinuousRevalidationInputV2,
    CommonArticulationPositiveThicknessCycleSchedulePathExtensionInputV1,
    ...
    UniformCycleClosureRootsV1, certify_admitted_positive_thickness_cycle_schedule_path_v2,
...
pub use general_cell_transport::{
    ...
    ChainedGeneralCellTransportAuthorityV1, CommonArticulationGeneralCellTransportExtensionInputV1,
    CommonArticulationGeneralMultiFaceCellTransportProofExtensionV1,
    GENERAL_CELL_TRANSPORT_CHAIN_LIMIT_V1, GENERAL_CELL_TRANSPORT_TOLERANCE_V1,
...
pub use graph_positive_thickness::{
    ...
    certify_common_articulation_admitted_flat_shared_feature_contacts_v2,
    certify_common_articulation_admitted_flat_shared_feature_contacts_with_checkpoint_v2,
    prove_common_articulation_admitted_positive_thickness_graph_geometry_v2,

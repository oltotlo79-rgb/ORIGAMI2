...
pub use continuous_path::{
    ...
    SharedVertexIntervalPositionV1, SharedVertexTreeLayerTransportProofV1,
    ...
    diagnose_dyadic_shared_vertex_interval_positions_v1, diagnose_scheduled_cycle_path_v1,

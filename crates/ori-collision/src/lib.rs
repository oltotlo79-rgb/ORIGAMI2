...
pub use continuous_path::{
    ...
    DyadicSharedVertexSectorBoundaryDiagnosticV1, ExactDyadicPathIntersectionErrorV1,
    ...
    SharedVertexContinuousCorridorGapReportV1, SharedVertexContinuousCorridorGapV1,
    SharedVertexIntervalPositionV1, SharedVertexSectorBoundaryV1,
    ...
    diagnose_dyadic_shared_vertex_sector_boundaries_v1, diagnose_scheduled_cycle_path_v1,

...
pub use beginner_generation::{
    ...
    BeginnerBodyOutlineModeV1, BeginnerBulgeTargetV1, BeginnerComponentBridgeOverrideV1,
    ...
    BeginnerSilhouetteCropRoiV1, BeginnerSilhouettePolarityV1, BeginnerSilhouetteThresholdsV1,

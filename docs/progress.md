...
| 2D展開図エディター | 15% | 35% | 5.25% | 基本編集、計測、任意多角形用紙の境界編集、補助線、交点接続と7種のスナップを実装 |
| 数式・幾何制約 | 9% | 36% | 3.24% | 完全な紙境界検証、矩形生成、比例変換、辺・X交点・T字交点分割、方向スナップの異常値防御を実装 |
...
| 多言語・設定・配布・QA | 5% | 22% | 1.10% | 両OS CI、正式形式のアプリアイコン、macOS bundle検証、幾何・スナップ・性能テストを追加 |
...
- スナップ単体・性能テスト48件と、X交点・T字交点編集を含むori-coreテスト67件

...
| 3D折り・紙厚・衝突 | 17% | 45% | 7.65% | H/Shift+Hのヒンジ巡回、F/Shift+Fの固定面巡回、Escape解除を3D選択同期とアクセシブルな通知へ接続 |
...
| 多言語・設定・配布・QA | 5% | 66% | 3.30% | 両OS CI、実ファイル回帰に加え、3Dキーボード選択を含むfrontend 515件、Rust 302件を検証 |

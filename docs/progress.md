...
**全体完成率: 約29.9%（2026-07-18、暫定の重み付き概算）**
...
| 入出力・互換性 | 5% | 30% | 1.50% | `.ori2`に加え、FOLD 1/1.1/1.2の2D `creasePattern`取込、プレビュー、縮尺・線種・警告確認、原子的な新規未保存project化を実装。SVG取込、FOLDの3D・複数frame、各形式の出力を残す |
...
- SVG取込を、FOLD取込と同じpreview・mapping確認・警告・原子的適用の利用者経路へ接続する作業
...
1. SVG読込を、線色・線種・属性のmapping確認、情報損失警告、原子的な新規未保存project化まで一つの利用者経路として実装する
2. 続いてFOLD/SVG出力、手順画像・PDF出力を利用者経路単位で追加する

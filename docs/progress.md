...
| 3D折り・紙厚・衝突 | 17% | 30% | 5.10% | 広域候補を倍精度三角柱SATで狭域化し、非隣接貫通・接触・ヒンジ未解決・不確定を現在姿勢の3Dへ表示 |
...
| 多言語・設定・配布・QA | 5% | 49% | 2.45% | 両OS CI、実ファイル回帰に加え、広域・三角柱SAT・数値不確定を含むfrontend 182件を検証 |
...
- frontend単体・性能テスト182件と、X交点・通常/輪郭T字・最大64辺クラスタ編集・複数折り面解析を含むori-coreテスト95件

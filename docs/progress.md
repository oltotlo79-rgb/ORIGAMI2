...
| 3D折り・紙厚・衝突 | 17% | 31% | 5.27% | 広域・三角柱SAT診断に加え、高頻度角度入力を最新1件/描画フレームへ統合して重複計算を抑制 |
...
| 多言語・設定・配布・QA | 5% | 50% | 2.50% | 両OS CI、実ファイル回帰に加え、広域・三角柱SAT・フレーム統合を含むfrontend 186件を検証 |
...
- frontend単体・性能テスト186件と、X交点・通常/輪郭T字・最大64辺クラスタ編集・複数折り面解析を含むori-coreテスト95件

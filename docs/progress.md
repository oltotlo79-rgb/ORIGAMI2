...
- 既存プロジェクトの紙厚、表裏色、切断可否をUndo/Redo可能に編集する操作
...
3. 紙厚、表裏色、切断可否を1操作で更新し、Undo/Redoと保存へ統合する

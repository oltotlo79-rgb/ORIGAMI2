...
| 2D展開図エディター | 15% | 33% | 4.95% | 基本編集、計測、任意多角形用紙の境界編集、補助線、交点接続と5種のスナップを実装 |
| 数式・幾何制約 | 9% | 35% | 3.15% | 完全な紙境界検証、矩形生成、比例変換、辺・X交点・T字交点分割とスナップの異常値防御を実装 |
...
| 多言語・設定・配布・QA | 5% | 21% | 1.05% | 両OS CI、正式形式のアプリアイコン、macOS bundle検証、幾何・スナップ・性能テストを追加 |
...
- スナップ単体・性能テスト37件と、X交点・T字交点編集を含むori-coreテスト67件

...
| 3D折り・紙厚・衝突 | 17% | 34% | 5.78% | 広域・三角柱SAT・問題面輪郭に加え、回転・拡大縮小・平行移動・視点リセットを実装 |
...
| 多言語・設定・配布・QA | 5% | 53% | 2.65% | 両OS CI、実ファイル回帰に加え、複数ポインター・JISキー・高さ0境界を含むfrontend 207件を検証 |
...
- frontend単体・性能テスト207件と、X交点・通常/輪郭T字・最大64辺クラスタ編集・複数折り面解析を含むori-coreテスト95件
...
5. 3D要素のキーボード選択、ネイティブE2E、終了時保護を進める
